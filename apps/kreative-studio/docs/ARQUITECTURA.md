...
| MinIO / S3 | `shell.files` (§7.e): el Cloud Storage del tenant, con la ruta puesta por el host bajo la carpeta de la app |
...
│                 vía `shell.files` §7.e, directorio de usuarios,        │
│                 notificación, config, documentos), carga y guardado    │
│  42-agent       tools del agente de KIMOS y su despachador             │
│  50-58          22 vistas: 55 el Flujo (4 presentaciones), 56 la        │
│                 Organización, los Archivos y la Distribución            │
