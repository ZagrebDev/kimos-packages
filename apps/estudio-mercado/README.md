...
Registra nueve herramientas: `SET_SUPUESTO`, `SET_DESCUENTO_PLAN`,
`SET_PRECIO_COMPETIDOR`, `COTIZAR`, `SET_ALCANCE`, `VER_PESTANA`, `VER_MODULO`,
`SET_TEMA` y `RESTAURAR_SUPUESTOS`. El snapshot se recalcula al
