  ...
  function stepsMessage(item, warns) {
    ...
    if (sinCosto.length) {
      ...
      msg += ' OJO: ' + sinCosto.length + ' valor(es) SIN componentes ni recargo — no suman costo, ni foto, ni stock: '
        ...
        + '. Si representan hardware/insumos reales, reenvía los pasos enlazando cada valor a su componente del catálogo (components: [nombre exacto]); solo las opciones estéticas sin costo van sin componentes.';
    }
