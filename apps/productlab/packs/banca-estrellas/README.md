# Pack Banca Estrellas y Luna — del personalizador a ProductLab

Mueble infantil de **terciado de abedul** (40 cm de lado mayor, medido del GLB).
Partes tintables: **Laterales**, **Asiento** · 6 acabados.
...
`public/models/banca_estrellas.glb` y `public/textures/plywood_col.webp` (una sola vez, sirve para todos).

## Pasos del demo

1. **Crear el producto** `Banca Estrellas y Luna` en ProductLab (pestaña Productos → + Añadir).
2. **Pestaña Visor 3D** → activar → **Subir .glb** (`banca_estrellas.glb`). Copia la URL.
