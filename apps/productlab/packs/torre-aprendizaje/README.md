# Pack Torre de Aprendizaje — del personalizador a ProductLab

Mueble infantil de **terciado de abedul** (88 cm de lado mayor, medido del GLB).
Partes tintables: **Peldaños**, **Estructura** · 6 acabados.
...
`public/models/torre_aprendizaje.glb` y `public/textures/plywood_col.webp` (una sola vez, sirve para todos).

## Pasos del demo

1. **Crear el producto** `Torre de Aprendizaje` en ProductLab (pestaña Productos → + Añadir).
2. **Pestaña Visor 3D** → activar → **Subir .glb** (`torre_aprendizaje.glb`). Copia la URL.
