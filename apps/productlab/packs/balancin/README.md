# Pack Balancín — del personalizador a ProductLab

Mueble infantil de **terciado de abedul** (122 cm de lado mayor, medido del GLB).
Partes tintables: **Laterales**, **Peldaños** · 6 acabados.
...
`public/models/balancin.glb` y `public/textures/plywood_col.webp` (una sola vez, sirve para todos).

## Pasos del demo

1. **Crear el producto** `Balancín` en ProductLab (pestaña Productos → + Añadir).
2. **Pestaña Visor 3D** → activar → **Subir .glb** (`balancin.glb`). Copia la URL.
