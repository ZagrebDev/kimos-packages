# Pack Camarote — del personalizador a ProductLab

Mueble infantil de **terciado de abedul** (230 cm de lado mayor, medido del GLB).
...
`public/models/camarote.glb` y `public/textures/plywood_col.webp` (una sola vez, sirve para todos).

## Pasos del demo

1. **Crear el producto** `Camarote` en ProductLab (pestaña Productos → + Añadir).
2. **Pestaña Visor 3D** → activar → **Subir .glb** (`camarote.glb`). Copia la URL.
