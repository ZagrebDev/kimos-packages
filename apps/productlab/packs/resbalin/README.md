# Pack Resbalín — del personalizador a ProductLab

Mueble infantil de **terciado de abedul** (190 cm de lado mayor, medido del GLB).
Partes tintables: **Deslizador**, **Laterales**, **Peldaños** · 6 acabados.
...
`public/models/resbalin.glb` y `public/textures/plywood_col.webp` (una sola vez, sirve para todos).

## Pasos del demo

1. **Crear el producto** `Resbalín` en ProductLab (pestaña Productos → + Añadir).
2. **Pestaña Visor 3D** → activar → **Subir .glb** (`resbalin.glb`). Copia la URL.
