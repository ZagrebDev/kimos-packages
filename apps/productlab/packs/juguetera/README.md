# Pack Juguetera — del personalizador a ProductLab

Mueble infantil de **terciado de abedul** (139 cm de lado mayor, medido del GLB).
...
`public/models/juguetera.glb` y `public/textures/plywood_col.webp` (una sola vez, sirve para todos).

## Pasos del demo

1. **Crear el producto** `Juguetera` en ProductLab (pestaña Productos → + Añadir).
2. **Pestaña Visor 3D** → activar → **Subir .glb** (`juguetera.glb`). Copia la URL.
