# Pack Ropero Organizador — del personalizador a ProductLab

Mueble infantil de **terciado de abedul** (120 cm de lado mayor, medido del GLB).
Partes tintables: **Repisas**, **Ganchos**, **Estructura** · 6 acabados.
...
`public/models/ropero.glb` y `public/textures/plywood_col.webp` (una sola vez, sirve para todos).

## Pasos del demo

1. **Crear el producto** `Ropero Organizador` en ProductLab (pestaña Productos → + Añadir).
2. **Pestaña Visor 3D** → activar → **Subir .glb** (`ropero.glb`). Copia la URL.
