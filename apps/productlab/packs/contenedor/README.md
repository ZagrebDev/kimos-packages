# Pack Contenedor Pequeño — del personalizador a ProductLab

Mueble infantil de **terciado de abedul** (63 cm de lado mayor, medido del GLB).
Partes tintables: **Laterales**, **Cuerpo** · 6 acabados.
...
`public/models/contenedor.glb` y `public/textures/plywood_col.webp` (una sola vez, sirve para todos).

## Pasos del demo

1. **Crear el producto** `Contenedor Pequeño` en ProductLab (pestaña Productos → + Añadir).
2. **Pestaña Visor 3D** → activar → **Subir .glb** (`contenedor.glb`). Copia la URL.
