# Pack Panel Ranurado — del personalizador a ProductLab

Mueble infantil de **terciado de abedul** (100 cm de lado mayor, medido del GLB).
Partes tintables: **Paneles**, **Accesorios** · 6 acabados.
...
`public/models/panel_ranurado.glb` y `public/textures/plywood_col.webp` (una sola vez, sirve para todos).

## Pasos del demo

1. **Crear el producto** `Panel Ranurado` en ProductLab (pestaña Productos → + Añadir).
2. **Pestaña Visor 3D** → activar → **Subir .glb** (`panel_ranurado.glb`). Copia la URL.
