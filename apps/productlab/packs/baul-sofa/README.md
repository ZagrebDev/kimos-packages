# Pack Baúl Sofá — del personalizador a ProductLab

Mueble infantil de **terciado de abedul** (94 cm de lado mayor, medido del GLB).
...
`public/models/baul_sofa.glb` y `public/textures/plywood_col.webp` (una sola vez, sirve para todos).

## Pasos del demo

1. **Crear el producto** `Baúl Sofá` en ProductLab (pestaña Productos → + Añadir).
2. **Pestaña Visor 3D** → activar → **Subir .glb** (`baul_sofa.glb`). Copia la URL.
