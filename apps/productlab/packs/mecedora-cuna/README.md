# Pack Mecedora Cuna — del personalizador a ProductLab

Mueble infantil de **terciado de abedul** (149 cm de lado mayor, medido del GLB).
...
`public/models/mecedora_cuna.glb` y `public/textures/plywood_col.webp` (una sola vez, sirve para todos).

## Pasos del demo

1. **Crear el producto** `Mecedora Cuna` en ProductLab (pestaña Productos → + Añadir).
2. **Pestaña Visor 3D** → activar → **Subir .glb** (`mecedora_cuna.glb`). Copia la URL.
