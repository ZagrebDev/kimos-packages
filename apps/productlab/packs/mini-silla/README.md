# Pack Mini Silla — del personalizador a ProductLab

Mueble infantil de **terciado de abedul** (48 cm de lado mayor, medido del GLB).
Partes tintables: **Asiento**, **Estructura** · 6 acabados.
...
`public/models/mini_silla.glb` y `public/textures/plywood_col.webp` (una sola vez, sirve para todos).

## Pasos del demo

1. **Crear el producto** `Mini Silla` en ProductLab (pestaña Productos → + Añadir).
2. **Pestaña Visor 3D** → activar → **Subir .glb** (`mini_silla.glb`). Copia la URL.
