...
| `estudio-mercado` 🎯 | **Estudios de mercado competitivo** como tablero interactivo, con modo dashboard, compacto y tema de KIMOS, adaptado de móvil a tótem. Trae hecho el de KIMOS —25 líneas contra 170 planes de precio de la competencia, con gráficos en vivo, precios editables, configurador de suscripción, mercado por país, unit economics y diagnóstico— y sirve para hacer el de **cualquier otra empresa**: nueve plantillas de rubro, editores de líneas y precios con fuente obligatoria, documentos de respaldo (capturas, aranceles, propuestas, planillas) guardados en el almacenamiento del equipo y atados al precio que prueban, importar y exportar el estudio como JSON, control de vigencia de la evidencia y un protocolo de investigación que el agente IA puede ejecutar solo. Ver [`apps/estudio-mercado/`](apps/estudio-mercado/). |
...
| `cashflow` 💰 | **Agente Financiero Inteligente**: flujo de caja multiempresa con bruto/neto/IVA sincronizados en vivo, libro diario con asientos Debe/Haber, gestor documental que interpreta XML DTE y PDF con texto embebido 100% local con confianza por campo, bandeja de Revisión donde la IA solo propone y la persona aprueba (Human in the Loop), memoria financiera que aprende de cada aprobación, dashboard de KPIs, proyecciones, presupuestos y análisis con alertas. El proveedor o cliente de cada movimiento es la misma identidad que en el resto de KIMOS (`shell.records`) y la empresa emisora sale de la marca del tenant. Ver [`apps/cashflow/`](apps/cashflow/). |
